...
_LIBRARY = _descriptor.ServiceDescriptor(
  name='Library',
  full_name='libraryPackage.Library',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='AddBook',
    full_name='libraryPackage.Library.AddBook',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='ListBooks',
    full_name='libraryPackage.Library.ListBooks',
    index=1,
    containing_service=None,
    input_type=_VOID,
